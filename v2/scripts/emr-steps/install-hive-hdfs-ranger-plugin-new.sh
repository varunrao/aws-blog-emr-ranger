...
#Setup
sudo rm -rf $installpath/$ranger_hdfs_plugin
sudo rm -rf $installpath/hadoop
...
ln -s /etc/hadoop/hdfs-site.xml /usr/lib/ranger/hadoop/etc/hadoop/hdfs-site.xml
...
#ln -s /etc/hadoop /usr/lib/ranger/hadoop/etc/
#ln -s /usr/lib/ranger/hadoop/etc/hadoop/conf/hdfs-site.xml /usr/lib/ranger/hadoop/etc/hadoop/hdfs-site.xml
#cp -r $installpath/$ranger_hdfs_plugin/lib/* /usr/lib/hadoop-hdfs/lib/
#cp /usr/lib/ranger/hadoop/etc/hadoop/conf/* /etc/hadoop/conf.empty/
#cp -r /usr/lib/ranger/hadoop/etc/hadoop/conf/* /etc/hadoop/conf/
#ln -s /etc/hadoop/ /usr/lib/ranger/hadoop/
